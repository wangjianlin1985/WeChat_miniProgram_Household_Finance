...
public class IncomeService {
    ...
    public ArrayList<Income> queryIncome(IncomeType incomeTypeObj,String incomeFrom,PayWay payWayObj,String payAccount,String incomeDate,UserInfo userObj,int currentPage) throws Exception { 
    	...
    	if(null != incomeTypeObj && incomeTypeObj.getIncomeTypeId()!= null && incomeTypeObj.getIncomeTypeId()!= 0)  where += " and t_income.incomeTypeObj=" + incomeTypeObj.getIncomeTypeId();
    ...
    /*查询最新收入信息记录*/
    public ArrayList<Income> queryZxIncome()  throws Exception {
        return incomeMapper.queryZxIncomeList();
    }
