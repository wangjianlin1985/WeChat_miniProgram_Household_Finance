		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>IncomeType/frontlist">收入类型列表</a></li>
			    	<li role="presentation" class="active"><a href="#incomeTypeAdd" aria-controls="incomeTypeAdd" role="tab" data-toggle="tab">添加收入类型</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="incomeTypeAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="incomeType_incomeTypeName" class="col-md-2 text-right">收入类别名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="incomeType_incomeTypeName" name="incomeType.incomeTypeName" class="form-control" placeholder="请输入收入类别名称">
							 </div>
						  </div>
				          <div class="form-group">
