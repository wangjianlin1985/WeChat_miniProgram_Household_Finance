...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>UserInfo/frontlist">家庭成员信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">亲友账号:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">家庭关系:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getHomeName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">职业:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getWorkName()%></div>
	</div>
	<div class="row bottom15"> 
