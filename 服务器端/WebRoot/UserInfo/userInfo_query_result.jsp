...
<div id="userInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="userInfoQueryForm" method="post">
			亲友账号：<input type="text" class="textbox" id="user_name" name="user_name" style="width:110px" />
...
<div id="userInfoEditDiv">
	<form id="userInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_homeName_edit" name="userInfo.homeName" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_workName_edit" name="userInfo.workName" style="width:200px" />
